...
from babylocoformer.assets.unitree.unitree import UNITREE_GO2_CFG as ROBOT_CFG
...
class EventCfg:
    ...
    reset_base = EventTerm(
        ...
        mode="reset",
        params={
            "pose_range": {"x": (-2.5, 2.5), "y": (-2.5, 2.5), "yaw": (0.14, 0.15)},
            "velocity_range": {
                "x": (0.0, 0.0),
                "y": (0.0, 0.0),
                "z": (0.0, 0.0),
    ...
    lock_knee = EventTerm(
        ...
        mode="startup",
        params={
            "asset_cfg": SceneEntityCfg("robot", joint_names=["FL_calf_joint"]),
            "lower": -2.5,
            "upper": -2.5,
        },
    )
...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformLevelVelocityCommandCfg(
        ...
        limit_ranges=mdp.UniformLevelVelocityCommandCfg.Ranges(
            lin_vel_x=(-1.0, 1.0), lin_vel_y=(-0.4, 0.4), ang_vel_z=(-0.6, 0.6)
        ),
    )
